      ...
      <div class="row mt-3 justify-content-center">
        <div class="col-md-8">
          <div class="bg-white rounded elevation-1 p-3">
            ...
            <div v-if="car.creatorId === account.id" class="car-controls d-flex justify-content-end">
              <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#car-modal">
                edit
              </button>
